...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const links = React.useMemo(() => [
        ...
        { href: "/rooms", icon: BedDouble, label: t("rooms") },
        { href: "/stays", icon: CalendarRange, label: t("stays") },
        { href: "/tickets", icon: Ticket, label: t("ticketsNav") },
        { href: "/messages", icon: MessageSquare, label: t("messagesNav") },
    ], [t]);
