        ...
        <div className="px-4 py-6 max-w-2xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-xs text-white/40 mt-1">Report and track issues</p>
                </div>
                <Button
                    variant="default"
                    size="sm"
                    className="bg-gradient-to-r from-primary to-accent border-0 glow-primary"
                ...
                <div className="space-y-3">
                    {myTickets.map((ticket, idx) => (
                        <motion.button
                            ...
                            className="w-full text-left glass-panel rounded-2xl p-4 hover:bg-white/10 transition-colors"
                        >
                            <div className="flex justify-between items-start mb-2">
                                <div className="flex items-center gap-2">
                                    <span className="text-xs font-mono font-bold text-white/60">{ticket.id}</span>
                            ...
                            <div className="flex items-center gap-2 mt-2 text-xs text-white/30">
                                ...
                                <Badge variant="glass" className="text-[10px] text-white/50 ml-auto">{ticket.category}</Badge>
                            </div>
                        </motion.button>
                    ))}
                </div>
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none text-gray-800"
                        />
                    </div>
                    <Button
                        variant="default"
